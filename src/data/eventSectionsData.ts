export const eventSections = [
  ...
  },
  {
    ...
    events: [
      { id: "01", name: "Workshop and Training Session" },
      { id: "02", name: "College Fairs" },
      { id: "03", name: "Orientation" },
      { id: "04", name: "Rag days" },
      { id: "05", name: "Flash mob" },
    ],
    images: [
      {
        src: "/events-page/wedding-1.png",
  ...
  },
  {
    ...
    events: [
      { id: "01", name: "Found raising Galas" },
      { id: "02", name: "Charity Auctions" },
      { id: "03", name: "Awareness Campaigns" },
      { id: "04", name: "Community Service And events" },
    ],
    images: [
      {
        src: "/events-page/wedding-1.png",
        alt: "Charity Events 1",
      },
      {
        src: "/events-page/wedding-2.png",
        alt: "Charity Events 2",
      },
      {
        src: "/events-page/wedding-3.png",
        alt: "Charity Events 3",
      },
      {
        src: "/events-page/wedding-4.png",
        alt: "Charity Events 4",
      },
      {
        src: "/events-page/wedding-5.png",
        alt: "Charity Events 5",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "/events-page/wedding-1.png",
        alt: "Government Events 1",
      },
      {
        src: "/events-page/wedding-2.png",
        alt: "Government Events 2",
      },
      {
        src: "/events-page/wedding-3.png",
        alt: "Government Events 3",
      },
      {
        src: "/events-page/wedding-4.png",
        alt: "Government Events 4",
      },
      {
        src: "/events-page/wedding-5.png",
        alt: "Government Events 5",
      },
    ],
  },
  {
    ...
    events: [
      { id: "01", name: "Birthday Party" },
      { id: "02", name: "Anniversary" },
      { id: "03", name: "Proposal Planning" },
      { id: "04", name: "Valentine greetings" },
      { id: "05", name: "Bachelor party" },
    ],
    images: [
      {
        src: "/events-page/wedding-1.png",
        alt: "Private Events 1",
      },
      {
        src: "/events-page/wedding-2.png",
        alt: "Private Events 2",
      },
      {
        src: "/events-page/wedding-3.png",
        alt: "Private Events 3",
      },
      {
        src: "/events-page/wedding-4.png",
        alt: "Private Events 4",
      },
      {
        src: "/events-page/wedding-5.png",
        alt: "Private Events 5",
      },
    ],
  },
  {
    ...
    events: [
      { id: "01", name: "Virtual Conferences" },
      { id: "02", name: "Webinar" },
      { id: "03", name: "Virtual Trade Show" },
    ],
    images: [
      {
        src: "/events-page/wedding-1.png",
        alt: "Virtual Events 1",
      },
      {
        src: "/events-page/wedding-2.png",
        alt: "Virtual Events 2",
      },
      {
        src: "/events-page/wedding-3.png",
        alt: "Virtual Events 3",
      },
      {
        src: "/events-page/wedding-4.png",
        alt: "Virtual Events 4",
      },
      {
        src: "/events-page/wedding-5.png",
        alt: "Virtual Events 5",
      },
    ],
  },
];
